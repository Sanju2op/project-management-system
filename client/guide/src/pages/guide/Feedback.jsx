...
export default function Feedback() {
    ...
    const loadGroups = async () => {
      try {
        ...
        const normalized = (groups || []).map((g) => ({
          id: g._id,                      // FIX
          name: g.name,                   // FIX
          projectTitle: g.projectTitle    // FIX
        }));
  ...
  const submitFeedback = async () => {
    if (
      (newFeedback.groupId || newFeedback.groupName) &&
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-white/70">
              Provide feedback and track group responses
            </p>
          </div>
          <button
        ...
        <div className="bg-white/20 backdrop-blur-md p-6 rounded-3xl border border-white/30 shadow-glow">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <option value="Submitted" className="bg-gray-800 text-white">
                Submitted
              </option>
              <option
        ...
        {filteredFeedbacks.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-white/60">
              Start providing feedback to help groups improve
            </p>
          </div>
        )}
      </div>
                  ...
                  {[1, 2, 3, 4, 5].map((starRating) => (
                    ...
                    >
                      <Star
                        size={20}
                        className={
                          newFeedback.rating >= starRating ? "fill-current" : ""
                        }
                      />
                    </button>
                  ))}
