        ...
        <div className="lg:w-1/2 bg-gradient-to-br from-purple-600 via-pink-600 to-purple-800 p-12 text-white flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl opacity-90 leading-relaxed mb-8">
              Empower the next generation of innovators. Guide students through
              their academic journey with mentorship, feedback, and expertise.
            </p>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/90">
                  Provide expert feedback and evaluations
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
        ...
        <div className="lg:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
          ...
          <div className="mt-8 text-center">
            <p className="text-purple-200/70">
              ...
              <Link
                to="/guide/register"
                className="text-purple-300 hover:text-white font-semibold transition-colors duration-200 underline decoration-purple-400 underline-offset-4"
              >
                Create Account
              </Link>
            </p>
